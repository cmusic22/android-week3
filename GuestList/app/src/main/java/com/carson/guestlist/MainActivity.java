...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mClearGuestListButton = findViewById(R.id.clear_list_button);
        ...
        mAddGuestButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (newGuestName.trim().isEmpty()) {
                    Toast.makeText(MainActivity.this, "enter a name", Toast.LENGTH_LONG);
                    return;
                }
                mNewGuestNameInput.setText("");//clears text
